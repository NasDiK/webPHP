            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="roleName" class="col-md-4 col-form-label text-md-end">{{ __('Роль') }}</label>

                            <div class="col-md-6">
                                <select id="roleName" class="@error('roleName') is-invalid @enderror" name="roleName" autocomplete="STUDENT">
